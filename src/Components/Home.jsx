...
<span style={{ color: "greenyellow" }}>
  <Typewriter
    words={["Web Developer", "React Developer", "Frontend Engineer"]}
    loop={true}
    cursor
    cursorStyle="|"
    typeSpeed={70}
  ...
  />
    ...
    <section className="skill-section p-3" id="skill-section" style={{  background: 'linear-gradient(135deg, #5D5C61, #A8A7A7)', color: 'white' }}>
